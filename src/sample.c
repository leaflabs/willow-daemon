...
#define SAMPLE_BSAMP_SEC_P_BUF 5 /* seconds of data per sample buffer */
#define SAMPLE_BSAMP_MAXLEN ((size_t)(SAMPLE_BSAMP_KHZ * 1000 * \
                                      SAMPLE_BSAMP_SEC_P_BUF))
#define SAMPLE_BSAMP_TIMEOUT_SEC 10 /* WISHLIST: be smarter */
