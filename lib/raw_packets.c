...
const char* raw_r_addr_str(uint8_t r_type, uint8_t r_addr)
{
    ...
    case RAW_RTYPE_CENTRAL:
        ...
        case CASE_STRINGIFY(RAW_RADDR_CENTRAL_GIT_SHA_PIECE);
        case CASE_STRINGIFY(RAW_RADDR_CENTRAL_HDL_PARAM);
        case CASE_STRINGIFY(RAW_RADDR_CENTRAL_HDL_TIMESTAMP);
        case CASE_STRINGIFY(RAW_RADDR_CENTRAL_BOARD_ID);
